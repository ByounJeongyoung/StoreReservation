...
class RecommendAdapter: RecyclerView.Adapter<RecommendAdapter.Holder>(){
    val recommendList = arrayListOf<Int>(R.drawable.recomend1,R.drawable.recomend2,R.drawable.recomend3,R.drawable.recomend4,R.drawable.recomend5)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val binding = RecommendListBinding.inflate(LayoutInflater.from(parent.context),parent,false)
