...
class middleLayoutAdapter:RecyclerView.Adapter<middleLayoutAdapter.middleHolder>() {
    val listData = arrayListOf<String>("경기대","연무동","신사역","가로수길","강남","압구정","홍대","연남동","산본","인계동","부산","제주도")
    inner class middleHolder(val binding: LocalListBinding):RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): middleLayoutAdapter.middleHolder {
